    ...
    return (
      <Card className={classes.card}>
        <CardContent>
          ...
          <List>
            <ListItem>
              <ListItemText primary="Category" secondary={recipe.category} />
            </ListItem>
            <ListItem>
              <ListItemText
                primary="Description"
            ...
            <ListItem>
              <ListItemText primary="Creator" secondary={recipe.username} />
            </ListItem>
            <ListItem>
              <ListItemText
    ...
    <>
      ...
      <Box my={4}>
        <Typography variant="h6">
          ...
          <span>
            <a
              href="https://github.com/subaquatic-pierre/apollo-recipes"
              target="_blank"
            >
              README.md
            </a>
